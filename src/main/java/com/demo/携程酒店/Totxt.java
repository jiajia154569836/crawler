        ...
        try {
            ...
            BufferedWriter bWriter = new BufferedWriter(
                    new OutputStreamWriter(
                            new FileOutputStream("E:\\learn\\crawler\\src\\main\\webapp\\xiechengjiudian.txt"),"utf-8"));
            bWriter.write("");

            File input = new File("E:\\learn\\crawler\\src\\main\\webapp\\xiechengjiudian.txt");
    ...
    for(int ii=0;ii<linkf.childNodeSize();ii++)
    {
        ...
        ff= ff +  linkf.attr("title");
                  ...
                  //  tr.appendElement("td").text(j);
                   ...
                   // tr.appendElement("td").text(h);
                    tr.appendElement("td").text(j);
                    bWriter.write(urlss.trim().replace(" ","")+" ");
                    bWriter.write(linktltle.trim().replace(" ","")+" ");
                    bWriter.write(fc+g.trim().replace(" ","")+" ");
                    bWriter.write(prices.trim().replace(" ","")+" ");
                    bWriter.write(j.trim().replace(" ","")+" ");
                    bWriter.write("\n");
